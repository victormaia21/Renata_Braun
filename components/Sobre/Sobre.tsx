    ...
    return (
        ...
        <div className="w-7/8 justify-center items-center 2xl:flex 2xl:w-full 2xl:justify-center">
            <article className="flex flex-col 2xl:w-2/5 text-center">
                <h1 className="text-7xl font-bold text-[#97807d]">Sobre Renata Braun</h1>
                <ul className="list-disc text-left ml-16 mt-7 text-2xl font-[500] text-[#898989]">
                ...
                <button className="bg-[#815138] mt-10 text-white w-full pt-1 pb-1 text-4xl font-bold rounded-4xl cursor-pointer">Lee su entrevista completa</button>
            </article>
