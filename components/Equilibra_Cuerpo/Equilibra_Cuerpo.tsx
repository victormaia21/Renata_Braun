    ...
    return (
        <section className="lg:flex pt-24 pb-24 lg:w-4/5 lg:justify-center">
            ...
            <div className="w-full flex flex-col items-center text-left mt-48 lg:w-2/5 xl:items-start ">
                ...
                <p className="w-4/5 mt-3 text-sm text-[#aba79a]">Una terapia energética significa localizar los bloqueos energéticos que se originan por los pensamientos y emociones, para poder limpiar la energía densa y armonizar tu energía (chakras y campos energéticos).</p>
                <ul className="mt-4 flex flex-col gap-5 items-baseline pl-8 pr-8 xl:pl-0 xl:pr-0 text-[#815138]">
                ...
                <div className="flex justify-center w-full">
                    <button className="bg-[#815138] text-white mt-7 w-4/5 h-14 text-4xl font-bold rounded-4xl cursor-pointer">Reservar Cita</button>
                </div>
            </div>
        </section>
    )
