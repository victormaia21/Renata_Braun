    ...
    return (
        <section className="lg:flex pt-24 pb-24 lg:w-4/5 lg:justify-center">
            ...
            <div className="w-full flex flex-col items-center text-left mt-48 lg:w-2/5 xl:items-start ">
                <h1 className="text-[#767676] font-[900] text-5xl w-4/5">Equilibra tu cuerpo, alma y espíritu </h1>
                <p className="w-4/5 mt-3 text-sm">Una terapia energética significa localizar los bloqueos energéticos que se originan por los pensamientos y emociones, para poder limpiar la energía densa y armonizar tu energía (chakras y campos energéticos).</p>
