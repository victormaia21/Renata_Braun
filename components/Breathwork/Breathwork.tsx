  ...
  return (
    <section className="flex flex-col xl:flex-row gap-10 px-6 xl:px-24 py-10">
      ...
      <div className="w-full xl:w-3/5 flex flex-col items-center xl:items-end">
        <h1 className="text-[#360066] text-5xl font-[1000] text-center xl:text-right mb-6 xl:mr-16">
          Breathwork
        </h1>
      ...
      <div className="w-full xl:w-2/5 flex flex-col items-center xl:items-start justify-center mt-6 xl:mt-0">
        <h2 className="text-[#360066] font-[900] text-3xl text-center xl:text-left">
          Respira profundo. Libera. Despierta.
        </h2>
        <p className="text-xl font-[900] mt-2 text-justify">
        ...
        <button className="bg-[#CB0482] text-white text-2xl font-[900] py-3 px-6 mt-6 rounded-3xl cursor-pointer">
          Reservar mi Lugar
        </button>
      </div>
    </section>
